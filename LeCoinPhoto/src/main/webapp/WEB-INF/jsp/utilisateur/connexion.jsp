...
<!--                                 <label class="font-bold text-base">Login :</label><br><br>
 -->                                <input type="text" id="login" name="login" class="w-full bg-neutral-50 bg-opacity-50 rounded-md p-3 
" placeholder="Login" /><br><br>
                        
<!--                                 <label class="font-bold text-base">Mot de passe :</label><br><br>
