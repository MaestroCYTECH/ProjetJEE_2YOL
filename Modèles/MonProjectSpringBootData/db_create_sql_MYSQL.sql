-- SQLINES DEMO *** -----------
-- ATTENTION !!!
-- SQLINES DEMO *** commit apres avoir execute ce script
-- SQLINES DEMO *** ----------- 


-- SQLINES DEMO *** ----------------------------------------------------------------------
-- SQLINES DEMO *** decommenter  si les tables existent deja !
-- SQLINES DEMO *** ---------------------------------------------------------------------- 
 /* SQLINES DEMO *** de;
DROP TABLE produit;
...
*/
-- SQLINES DEMO *** ----------------------------------------------------------------------
-- SQLINES DEMO ***  decommenter  si les sequences existent deja !
-- SQLINES DEMO *** ----------------------------------------------------------------------
 /* SQLINES DEMO *** ent_seq;
...
-- SQLINES DEMO *** -----------
-- SQLINES DEMO *** or "categorie"
-- SQLINES DEMO *** ----------- 
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE categorie(
id_categ DECIMAL(19,0) NOT NULL,
code_categ VARCHAR(10) NULL,
libelle_categ VARCHAR(50) NULL,
PRIMARY KEY (id_categ)
);
-- SQLINES DEMO *** -----------
-- SQLINES DEMO *** or "client"
-- SQLINES DEMO *** -----------
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE `CLIENT`(
id_client DECIMAL(19,0) NOT NULL,
...
-- SQLINES DEMO *** -----------
-- SQLINES DEMO *** or "produit"
-- SQLINES DEMO *** -----------
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE produit(
id_produit DECIMAL(19,0) NOT NULL,
id_categ DECIMAL(19,0) NOT NULL,
desig_produit VARCHAR(100) NULL,
pu_produit DECIMAL(19,0)  NULL,
...
-- SQLINES DEMO *** -----------
-- SQLINES DEMO *** or "commande"
-- SQLINES DEMO *** -----------
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE commande(
id_commande DECIMAL(19,0) NOT NULL,
id_client DECIMAL(19,0)  NOT NULL,
id_produit DECIMAL(19,0)  NOT NULL,
...
-- SQLINES DEMO *** -----------
-- SQLINES DEMO *** or "ville"
-- SQLINES DEMO *** ----------- 
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE ville(
id_ville DECIMAL(19,0) NOT NULL,
...
-- SQLINES DEMO *** -----------
-- SQLINES DEMO *** e for "client_seq"
-- SQLINES DEMO *** -----------
CALL CreateSequence('client_seq', 4, 1)
 -- SQLINES DEMO *** sertions 
;

 -- SQLINES DEMO *** -----------
-- SQLINES DEMO *** e for "commande_seq"
-- SQLINES DEMO *** -----------
CALL CreateSequence('commande_seq', 15, 1)
 -- SQLINES DEMO *** sertions 
;
 ...
 -- SQLINES DEMO *** -----------
-- SQLINES DEMO *** e for "produit_seq"
-- SQLINES DEMO *** -----------
CALL CreateSequence('produit_seq', 24, 1)
 -- SQLINES DEMO *** sertions 
;

 
 -- SQLINES DEMO *** -----------
-- SQLINES DEMO *** e for "categorie_seq"
-- SQLINES DEMO *** -----------
CALL CreateSequence('categorie_seq', 21, 1)
 -- SQLINES DEMO *** sertions 
;
...
INSERT INTO commande VALUES ('1', '1', '10', '56', STR_TO_DATE('22/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('2', '1', '1', '1', STR_TO_DATE('23/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('3', '1', '20', '6544', STR_TO_DATE('22/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('4', '1', '1', '1', STR_TO_DATE('23/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('5', '2', '3', '1', STR_TO_DATE('20/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('6', '3', '14', '1', STR_TO_DATE('24/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('7', '3', '20', '2', STR_TO_DATE('24/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('8', '2', '3', '1', STR_TO_DATE('25/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('9', '2', '1', '1', STR_TO_DATE('25/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('10', '3', '1', '1', STR_TO_DATE('25/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('11', '3', '3', '1', STR_TO_DATE('24/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('12', '3', '4', '1', STR_TO_DATE('25/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('13', '2', '20', '1', STR_TO_DATE('23/11/2016', '%d/%m/%Y'), '1');
INSERT INTO commande VALUES ('14', '2', '16', '1', STR_TO_DATE('21/11/2016', '%d/%m/%Y'), '1');
